...
class Conexao {
     ...
     */
    public function __construct($nomeHost="localhost", $user="root", $pass="lobolandia1010", $banco="coopanest") {
    ...
    public function execSQL($sql) {
        return $this->query = mysql_query($sql) or die
    ...
    public function contarDados() {
        ...
        $totalReg = mysql_num_rows($this->query);
        return $totalReg;
    }
